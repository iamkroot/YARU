...
def run_test():
    file = Path("/home/kroot/Downloads/Material/CN/QP 2017.PDF")
    orig_data = file.read_bytes()
    tempdir = Path(tempfile.mkdtemp("yaru-test"))
...
def main():
    ...
    factors = {
        ...
        # "loss_corr": Factor("loss_corr", default=25),
        "dup_ratio": Factor("dup_ratio"),
        "delay": Factor("delay"),
        "jitter": Factor("jitter"),
        # "delay_jitter_corr": Factor("delay_jitter_corr", default=25),
        # "reorder_ratio": Factor("reorder_ratio"),
        # "reorder_corr": Factor("reorder_corr", default=25),
